...
def custom_model_hand():
    ...
    image_model.add(ZeroPadding2D((2, 2), batch_input_shape=(1, 50, 50, 3)))   
    ...
    image_model.add(MaxPooling2D((2, 2), strides=(2, 2), dim_ordering="th")) #convert 50x50 to 25x25
    ...
    image_model.add(MaxPooling2D((5, 5), strides=(5, 5), dim_ordering="th")) #convert 25x25 to 5x5
    ...
    image_model.add(Dense(1)) # ATTENTION j'ai mis 9 à la place de 10 mais pour le coup vraiment pas sûr qu'il fallait faire ça (c'est le nombre de position de la main à reconnaître)
